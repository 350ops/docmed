...
function generateWeeklyAvailability(): DayAvailability[] {
  ...
  for (let i = 0; i < 7; i++) {
    ...
    // Random slots (some days have more, some have none)
    const possibleSlots = ['09:00', '09:30', '10:00', '10:30', '11:00', '11:30', '12:00', '16:00', '16:30', '17:00', '17:30', '18:00'];
    const numSlots = Math.floor(Math.random() * 6); // 0-5 slots per day
    const slots: string[] = [];
...
export const MOCK_DOCTORS: Doctor[] = [
  {
    ...
    bio: 'Especialista en terapia cognitivo-conductual con más de 15 años de experiencia. Tratamiento de ansiedad, depresión, trastornos de personalidad y problemas de pareja. Enfoque humanista e integrador.',
  ...
  },
  {
    ...
    bio: 'Experto en dermatología estética y oncología cutánea. Miembro de la Academia Española de Dermatología. Especializado en tratamiento del acné, psoriasis y detección precoz de melanoma.',
    availability: generateWeeklyAvailability(),
    isVerified: true,
  ...
  },
  {
    ...
    bio: 'Atención integral a la mujer en todas las etapas de la vida. Especializada en control de embarazo de alto riesgo, fertilidad y menopausia. Consulta online disponible.',
    availability: generateWeeklyAvailability(),
    isVerified: true,
  ...
  },
  {
    ...
    bio: 'Especialista en pediatría y puericultura. Seguimiento del desarrollo infantil, vacunación y tratamiento de enfermedades pediátricas. Atención cercana y personalizada.',
    availability: generateWeeklyAvailability(),
    isVerified: true,
