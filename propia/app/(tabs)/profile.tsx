        ...
        <>
            <AnimatedView className='' animation='scaleIn'>
                <View className="p-10 items-center rounded-3xl bg-slate-200 mt-6 mb-8 dark:bg-dark-secondary">
                    ...
                    <ThemedText className='text-2xl font-semibold mt-4'>¿Nuevo en CareSalud?</ThemedText>
                    <ThemedText className="text-sm font-light text-center px-4 ">Publica tu consulta y gestiona tus citas en un solo lugar</ThemedText>
                    <Button title="Configurar consulta" className='mt-4' textClassName='text-white' href="/screens/add-property-start" />
                </View>
                <View className='px-4'>
                    <ListLink showChevron title="Citas" icon="CalendarCheck" href="/screens/reservations" />
                    <ListLink showChevron title="Pagos" icon="Banknote" href="/screens/earnings" />
                    <ListLink showChevron title="Insights" icon="BarChart" href="/screens/insights" />
                    <ListLink showChevron title="Configurar consulta" icon="PlusCircle" href="/screens/add-property-start" />
                </View>
            </AnimatedView>
        </>
    );
